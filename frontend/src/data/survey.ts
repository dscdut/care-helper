import { AnswersSurvey, Survey, SurveyStatus } from 'src/types/survey.type'
...
const answers = [
  ...
  {
    id: 2,
    content: 'Tôi đang sử dụng thuốc panadol extra, 1 ngày 1 viên'
  },
  {
    id: 3,
    content: 'Tốt'
...
export const sampleSurveyData: Survey[] = [
  {
    id: 1,
    form: JSON.stringify(answersSurvey),
    status: SurveyStatus.WAITING,
    patient: {
      id: 2,
      fullName: 'Carrie Stanton IV'
    },
    doctor: {
      id: 3,
      fullName: 'Lena Beier'
